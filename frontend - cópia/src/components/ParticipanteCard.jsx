    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-0.5 flex-1 min-w-0">
                <span className="text-base font-primary font-bold text-primary truncate">{participante.nome}</span>
                <span className="text-xs font-secondary text-primary/60 truncate">
                    {participante.email}

                    {participante.email2 ? <span className="mx-2 text-primary/30">|</span> : null}
                    {participante.email2}
                </span>
            </div>
